...
var mytests = function() {
  ...
  describe('Basic sqlitePlugin.openDatabase parameter test(s)', function() {
    ...
    var suiteName = 'plugin: ';
        ...
        it(suiteName + 'Open with no location setting (SUPPORTED by this version)', function(done) {
          try {
        ...
        it(suiteName + 'Open with location: 0 (REJECTED by this version)', function(done) {
          try {
            window.sqlitePlugin.openDatabase({ name: 'open-with-location-0.db', location: 0 }, function(db) {
              // NOT EXPECTED in this version:
              expect(false).toBe(true);
        ...
        it(suiteName + 'Open with location: 1 (REJECTED by this version)', function(done) {
          try {
        ...
        it(suiteName + "Open with iosDatabaseLocation: 'Documents' (REJECTED by this version)", function(done) {
          try {
            window.sqlitePlugin.openDatabase({
              name: 'open-iosDatabaseLocation-Documents.db',
        ...
        it(suiteName + "Open with iosDatabaseLocation: 'Library' (REJECTED by this version)", function(done) {
          try {
            window.sqlitePlugin.openDatabase({
              name: 'open-iosDatabaseLocation-Library.db',
    ...
    describe('Plugin - BASIC sqlitePlugin.deleteDatabase parameter check test(s)', function() {
      ...
      var suiteName = 'plugin: ';
        ...
        it(suiteName + 'sqlitePlugin.deleteDatabase with no location setting (SUPPORTED by this version)', function(done) {
          try {
            // FUTURE TBD test without callbacks?
            window.sqlitePlugin.deleteDatabase({name: 'my.bogus.db'}, function() {
              // NOT EXPECTED:
              expect(false).toBe(true);
        ...
        it(suiteName + 'sqlitePlugin.deleteDatabase with string parameter (SUPPORTED by this version)', function(done) {
          try {
            window.sqlitePlugin.deleteDatabase('my.bogus.db', function() {
              // NOT EXPECTED:
              expect(false).toBe(true);
        ...
        it(suiteName + 'sqlitePlugin.deleteDatabase with location: 0 (REJECTED by this version)', function(done) {
          try {
            window.sqlitePlugin.deleteDatabase({ name: 'my.bogus.db', location: 0 }, function() {
              // NOT EXPECTED:
              expect(false).toBe(true);
        ...
        it(suiteName + 'sqlitePlugin.deleteDatabase with location: 1 (REJECTED by this version)', function(done) {
          try {
            window.sqlitePlugin.deleteDatabase({ name: 'my.bogus.db', location: 1 }, function() {
              // NOT EXPECTED:
              expect(false).toBe(true);
        ...
        it(suiteName + "sqlitePlugin.deleteDatabase with iosDatabaseLocation: 'Documents' (REJECTED by this version)", function(done) {
          try {
            // FUTURE TBD test without callbacks?
            //window.sqlitePlugin.deleteDatabase({ name: 'my.db', iosDatabaseLocation: 'Documents' }); // callbacks ignored
            window.sqlitePlugin.deleteDatabase({ name: 'my.db', iosDatabaseLocation: 'Documents' }, function() {
              // NOT EXPECTED:
              expect(false).toBe(true);
        ...
        it(suiteName + "sqlitePlugin.deleteDatabase with iosDatabaseLocation: 'Library' (REJECTED by this version)", function(done) {
          try {
            // FUTURE TBD test without callbacks?
            //window.sqlitePlugin.deleteDatabase({ name: 'my.db', iosDatabaseLocation: 'Library' }); // callbacks ignored
            window.sqlitePlugin.deleteDatabase({ name: 'my.db', iosDatabaseLocation: 'Library' }, function() {
              // NOT EXPECTED:
              expect(false).toBe(true);
  ...
  describe('Plugin: db open-close-delete test(s)', function() {
    ...
    for (var i=0; i<pluginScenarioCount; ++i) {
      ...
      describe(pluginScenarioList[i] + ': repeated open/close/delete test(s)', function() {
        ...
        // Needed to support some large-scale applications:
        test_it(suiteName + ' immediate close, then delete & re-open allows subsequent queries to run', function () {
          // TBD POSSIBLY BROKEN on iOS/macOS due to current background processing implementation:
